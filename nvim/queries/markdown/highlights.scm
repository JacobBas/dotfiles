; Work around Neovim 0.12.x markdown fenced-code crashes from line conceals.
; This mirrors the bundled markdown highlight query, but keeps fenced-code
; delimiters as normal highlights instead of line conceals.
